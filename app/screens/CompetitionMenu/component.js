...
import { View, Text, TouchableOpacity, Share, StatusBar } from 'react-native';
    ...
    <View style={styles.container}>
      <View style={styles.contentDetail}>
        <View style={styles.titleDetail}>
          <Text style={styles.txtTitle}>{I18n.t('descCompetition')}</Text>
        </View>
        <View style={styles.categoryDetail}>
          <Text style={styles.txtCategory}>{I18n.t('sourceSwim')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descCompetition5')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descCompetition1')}</Text>
        </View>
        <View style={styles.descDetail1}>
          <Text style={styles.swimDesc}>{I18n.t('descCompetition2')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descCompetition3')}</Text>
        </View>
        <View style={styles.descDetail2}>
          <Text style={styles.swimDesc}>{I18n.t('descCompetition4')}</Text>
        </View>
      </View>
    </View>
  );
