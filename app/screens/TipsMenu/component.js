    ...
    <View style={styles.container}>
      <View style={styles.contentDetail}>
        <View style={styles.titleDetail}>
          <Text style={styles.txtTitle}>{I18n.t('descTips')}</Text>
        </View>
        <View style={styles.categoryDetail}>
          <Text style={styles.txtCategory}>{I18n.t('sourceSwim')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descTips9')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descTips1')}</Text>
        </View>
        <View style={styles.descDetail1}>
          <Text style={styles.swimDesc}>{I18n.t('descTips2')}</Text>
        </View>
        <View style={styles.descDetail2}>
          <Text style={styles.swimDesc}>{I18n.t('descTips3')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descTips4')}</Text>
        </View>
        <View style={styles.descDetail1}>
          <Text style={styles.swimDesc}>{I18n.t('descTips5')}</Text>
        </View>
        <View style={styles.descDetail}>
          <Text style={styles.swimDesc}>{I18n.t('descTips6')}</Text>
        </View>
        <View style={styles.descDetail1}>
          <Text style={styles.swimDesc}>{I18n.t('descTips7')}</Text>
        </View>
        <View style={styles.descDetail3}>
          <Text style={styles.swimDesc}>{I18n.t('descTips8')}</Text>
        </View>
      </View>
    </View>
  );
